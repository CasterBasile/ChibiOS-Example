...
/*
 * [NISC2025-GPIO09] - Threading Example 
...
#define RLED_LINE   PAL_LINE( GPIOA, 0U ) // ARDUINO A0
#define GLED_LINE   PAL_LINE( GPIOA, 1U ) // ARDUINO A1
#define BLED_LINE   PAL_LINE( GPIOA, 4U ) // ARDUINO A2
