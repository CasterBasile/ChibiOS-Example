 ...
 * to execute a continuous acquisition on a circular buffer triggered by
...
/*
 *  Calculate the average value of the two channels over
 *  ADC_GRP_BUF_DEPTH number of samples
 */
...
static THD_FUNCTION( thdAdc, arg ) {
  ...
  /*
   * ADC input:
   *    PORT A PIN 0 -> ADC1_CH1
   *    PORT A PIN 1 -> ADC1_CH2
   */
