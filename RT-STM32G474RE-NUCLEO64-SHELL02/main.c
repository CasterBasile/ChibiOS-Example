...
/*
 * [NISC2025-SHELL02] - Project-Local custom shell.
 * DESCRIPTION: The shell has been imported into the project to be modified.
 * This can be useful to change hardcoded strings and modify
 * the shell behaviour. shell.c has been modified to
 * change the string displayed at shell startup.
 */
...
static void cmd_led(BaseSequentialStream *chp, int argc, char *argv[]) {
  /*
   * static variables allow shell commands to keep state.
   */
