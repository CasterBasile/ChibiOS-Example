...
/*
 * [NISC2025-GPIO06] - Iterate through an array of output lines.
...
#define RLED_LINE   PAL_LINE( GPIOA, 5U ) // D13
#define GLED_LINE   PAL_LINE( GPIOA, 6U ) // D12
#define BLED_LINE   PAL_LINE( GPIOA, 7U ) // D11
