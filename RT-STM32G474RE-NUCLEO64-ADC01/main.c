 ...
 * (regular sequence with only one channel) and uses a callback to evaluate
...
#define LINE_TRIG              PAL_LINE( GPIOA, 1U ) // 1A
...
int main(void) {
   ...
   * GPIOA 0 -> A0
   */
  palSetPadMode(GPIOA, 0U, PAL_MODE_INPUT_ANALOG); //A0
